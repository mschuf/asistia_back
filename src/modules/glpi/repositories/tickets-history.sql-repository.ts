 ...
 * @description Consulta paginada del historial de tickets directo sobre tablas GLPI.
 */
...
const HISTORY_SORT_EXPRESSIONS: Record<HistorySortBy, string> = {
  ...
  openFor: "TIMESTAMPDIFF(SECOND, created_at, COALESCE(closed_at, solved_at, NOW()))",
...
/**
 * Repositorio SQL del historial de tickets directo sobre tablas GLPI.
 */
@Injectable()
export class TicketsHistorySqlRepository {
   ...
   * @param row - Fila SQL de historial.
