...
COMMENT ON COLUMN public.persona.foto IS 'Imagen de la persona procesada y comprimida (opcional).';
COMMENT ON COLUMN public.persona.foto_mime_type IS 'MIME type de la foto almacenada (p. ej. image/jpeg).';